...
<body style="background:#baed91">
  <section>
    ...
    <div class="user-intro"><i class="far fa-user fa-2x"></i>
  	...
  	<div class='title'><h1 style='margin:auto; text-align:center'>VSP</h1><p>Video Sharing Platform</p></div>
  </section>
  ...
  ?>
	    ...
	    <section class="sect2" style="margin-left:25%">
	      <video width = "800"; height = auto; align = center; autoplay controls loop src="http://pausch.cs.uakron.edu/~ys96/project/uploaded/<?php echo $row['name']?>"></video>
	      <br>
